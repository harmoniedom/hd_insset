...
class inssetHarmonie_List extends WP_List_Table {
    ...
    public function get_columns($columns = array()) {
        ...
        // $columns['CodePostal'] = __('CodePostal');
            ...
            $sql = "SELECT DISTINCT `cle` FROM " . $wpdb->prefix . 'insset_user' . " WHERE `cle` != ''";
